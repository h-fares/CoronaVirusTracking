      ...
      <div class="card" style="width: 18rem;">
        <div class="card-body">
          ...
          <p class="card-text m-2">
            Total <strong style="color: #dd4b39">Confirmed Cases</strong>
          </p>
          ...
          <p class="card-text m-2">
            Total <strong style="color: rgb(144, 237, 125)">Recovered</strong>
          </p>
          ...
          <p class="card-text m-2">
            New <strong style="color: #dd4b39">Confirmed Cases</strong>
          </p>
